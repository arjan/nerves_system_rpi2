...
WPE_VERSION = 16cff02d07dbce10c8fbb20ee2f8e88e120066ea
...
WPE_EXTRA_FLAGS += \
	-DCMAKE_C_FLAGS_RELEASE="$(call qstrip,$(TARGET_CFLAGS)) -O0 -g -Wno-cast-align $(WPE_EXTRA_CFLAGS)" \
	-DCMAKE_CXX_FLAGS_RELEASE="$(call qstrip,$(TARGET_CXXFLAGS)) -O0 -g -Wno-cast-align $(WPE_EXTRA_CFLAGS)"
else
WPE_EXTRA_FLAGS += \
